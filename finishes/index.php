            ...
            <div class="small-11 columns small-centered small-padding-top-4">
                ...
                <nav class="finishes text-center">
                    <ul>
                        ...
                        <li ng-class="{ 'color-primary border-primary-bottom': search.finish === 'airless' }" ng-init="search.finish = search.finish" ng-click="toStart(); search.finish = search.finish"><a href="#/polomyx-airless">Polomyx Airless</a></li>
                        ...
                        <li ng-class="{ 'color-primary border-primary-bottom': search.finish === 'lightvision' }" ng-init="search.finish = search.finish" ng-click="toStart(); search.finish = search.finish"><a href="#/light-vision">Light Vision</a></li>
                    </ul>
                </nav>
                    ...
                    <div class="small-12 columns small-margin-top-2">
                        ...
                        <div class="medium-2 columns medium-text-center medium-padding-0 small-margin-bottom-1">
                            <label class="text-smaller medium-margin-top-2 small-margin-top-1">
                                <input ng-model="search.new" ng-true-value="1" ng-false-value="" ng-change="toStart()" class="small-margin-0" type="checkbox" />
                                New Colors      
                            </label>
                        </div>
                    </div>
