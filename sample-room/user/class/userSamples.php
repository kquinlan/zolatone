<div class="small-margin-bottom-2">
    <div class="color-thumb small-6 medium-4 large-4 columns left" ng-repeat="color in userColors" ng-class="{background-primary : color.isAdded}">
    	<!-- User Colors -->
    ...
    <div class="small-12 columns text-center">
    	...
    	<button class="small-margin-0" ng-show="colorCardMode" ng-disabled="colorCardColors.length < 9">Continue</button>
    	<button class="small-margin-0" ng-show="colorCardMode" ng-click="exitColorCardMode()" ng-disabled="userColors.length % 9 !== 0">Cancel</button>
    </div>
</div>